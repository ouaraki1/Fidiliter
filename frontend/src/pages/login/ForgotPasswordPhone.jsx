    ...
    <div className="flex items-center justify-center min-h-[72vh] px-4">
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-sm">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl font-bold text-text-dark">Forgot Password</h2>
          <p className="mt-1 text-sm text-gray-600">Enter your registered phone number to receive a verification code.</p>
        </div>
        ...
        <form onSubmit={handleSendOTP} className="mt-6 space-y-5">
          ...
          <div className="text-center">
            <button type="button" onClick={() => (window.location.href = "/login")} className="text-accent-brown underline">
